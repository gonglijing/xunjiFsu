...
var (
	...
	apiErrDebugModbusParamInvalid         = newAPIError("E_DEBUG_MODBUS_PARAM_INVALID", "串口 Modbus 调试参数无效")
	apiErrDebugModbusSerialFailed         = newAPIError("E_DEBUG_MODBUS_SERIAL_FAILED", "串口 Modbus 调试通信失败")
	apiErrDebugModbusTCPFailed            = newAPIError("E_DEBUG_MODBUS_TCP_FAILED", "Modbus TCP 调试通信失败")
	apiErrDebugModbusResponseInvalid      = newAPIError("E_DEBUG_MODBUS_RESPONSE_INVALID", "Modbus 调试响应无效")
	...
	apiErrGetAlarmRepeatIntervalFailed    = newAPIError("E_GET_ALARM_REPEAT_INTERVAL_FAILED", "获取报警重复触发间隔失败")
	apiErrUpdateAlarmRepeatIntervalFailed = newAPIError("E_UPDATE_ALARM_REPEAT_INTERVAL_FAILED", "更新报警重复触发间隔失败")
	apiErrInvalidAlarmRepeatInterval      = newAPIError("E_INVALID_ALARM_REPEAT_INTERVAL", errAlarmRepeatIntervalInvalidMessage)
