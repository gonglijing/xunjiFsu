...
var (
	...
	apiErrGetAlarmRepeatIntervalFailed    = newAPIError("E_GET_ALARM_REPEAT_INTERVAL_FAILED", "获取报警重复上报间隔失败")
	apiErrUpdateAlarmRepeatIntervalFailed = newAPIError("E_UPDATE_ALARM_REPEAT_INTERVAL_FAILED", "更新报警重复上报间隔失败")
