...
func TestParseHistoryDataQuery_StartAfterEnd(t *testing.T) {
	...
	if err.Error() != errHistoryStartAfterEnd {
		t.Fatalf("error = %q, want %q", err.Error(), errHistoryStartAfterEnd)
	}
}
...
func TestParseHistoryDataQuery_FilterRequiresDeviceID(t *testing.T) {
	...
	if err.Error() != errHistoryFilterRequires {
		t.Fatalf("error = %q, want %q", err.Error(), errHistoryFilterRequires)
	}
}
...
func TestParseHistoryDataQuery_InvalidDeviceIDValue(t *testing.T) {
	...
	if err.Error() != errInvalidDeviceID {
		t.Fatalf("error = %q, want %q", err.Error(), errInvalidDeviceID)
	}
}
...
func TestParseHistoryPointQuery_FieldNameRequired(t *testing.T) {
	...
	if err.Error() != errHistoryFieldRequired {
		t.Fatalf("error = %q, want %q", err.Error(), errHistoryFieldRequired)
	}
}
