...
const REQUEST_ERROR_MESSAGES = {
  ...
  E_HISTORY_POINT_QUERY_INVALID: '历史测点参数无效',
};
...
const NORTHBOUND_ERROR_MESSAGES = {
  ...
  E_NORTHBOUND_SYNC_DEVICES_FAILED: '同步设备失败',
...
const DATA_ERROR_MESSAGES = {
  ...
  E_CLEAR_HISTORY_DATA_FAILED: '清除历史数据失败',
  E_LIST_PAGINATED_DATA_POINTS_FAILED: '分页查询历史数据失败',
};

const DEBUG_ERROR_MESSAGES = {
  E_DEBUG_MODBUS_PARAM_INVALID: '串口 Modbus 调试参数无效',
  E_DEBUG_MODBUS_SERIAL_FAILED: '串口 Modbus 通信失败',
  E_DEBUG_MODBUS_TCP_FAILED: 'Modbus TCP 通信失败',
  E_DEBUG_MODBUS_RESPONSE_INVALID: 'Modbus 调试响应无效',
};
